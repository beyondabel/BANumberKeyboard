...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [self.button setBackgroundImage:[BAButton imageColor:[UIColor colorFromHexString:@"#f7f7f7"]] forState:UIControlStateNormal];
        [self.button setBackgroundImage:[BAButton imageColor:[UIColor colorFromHexString:@"#c9cbd0"]] forState:UIControlStateHighlighted];
